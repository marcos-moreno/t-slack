...
var application = new Vue({
    ...
    data:{ 
        ...
        segmentoCollection : [],
        isFormCrud: false,
        path : '../../models/bd/bd_segmento.php',
        typeMessage : '',
        msg:'',
        empresaCollection:[],
    ...
    methods:{
        ...
        search_segmentoByID(id_segmento){
            ...
            this.segmento = {id_segmento:0,id_empresa:'',id_creadopor:'',fecha_creado:'',nombre:'',observaciones:'',activo:'',id_actualizadopor:'',fecha_actualizado:''};
        },
