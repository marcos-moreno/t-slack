...
var application = new Vue({
    ...
    data:{ 
        ...
        ev_ticketCollection : [],
        isFormCrud: false,
        path : '../../models/../ev/ev_ticket/bd_ev_ticket.php',
        typeMessage : '',
        msg:'',
    ...
    methods:{
        ...
        async delete_ev_ticket(ev_ticket_id){   
            if(ev_ticket_id > 0){
                const response = await this.request(this.path,{model:{'ev_ticket_id':ev_ticket_id},'action' : 'delete'});
        ...
        search_ev_ticketByID(ev_ticket_id){
            ...
            this.ev_ticket = {ev_ticket_id:0,problema:'',observacion:'',fechacreacion:'',fechasolucion:'',estado:'',ev_catalogo_ticket_id:''};
        },
        ...
        async fill_f_keys(){
            ...
            const response_ev_catalogo_ticket = await this.request('../../models/ev_catalogo_ticket/bd_ev_catalogo_ticket.php',{'order' : 'ORDER BY ev_catalogo_ticket_id DESC','action' : 'select'});
            try{  
