                    ...
                    <div  class="modal-dialog modal-dialog-scrollable" >
                        <div class="modal-content">
                            ...
                            <table border="1">
                                ...
                                <tr><td>SUELDO MÍNIMO:</td><td>{{perfil.tabulador_minimo[0].tabulador}} ${{perfil.tabulador_minimo[0].sueldo}}</td></tr> 
                                <tr><td>SUELDO MÁXIMO:</td><td>{{perfil.tabulador_maximo[0].tabulador}} ${{perfil.tabulador_maximo[0].sueldo}}</td></tr> 
