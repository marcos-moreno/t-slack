...
<div class="container" style="width:90%">  
    ...
    <transition name="model">
        ...
        <div class="table-responsive"  >
            <table class="table table-bordered table-striped" style="height: 90px;" >
                <tr>
                    <td >
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr v-for="solicitud_uniforme in solicitud_uniformeCollection" >
                        ...
                        <td style="width:150px" >
                            <button type="button" class="btn btn" @click="update_solicitud_uniforme(solicitud_uniforme.id_solicitud_uniforme)"  v-if="solicitud_uniforme.estado == 'BO'" ><img src="../../img/lapiz.svg" width="25px" /></button>
                            <button type="button" class="btn btn" @click="delete_solicitud_uniforme(solicitud_uniforme.id_solicitud_uniforme)"  v-if="solicitud_uniforme.estado == 'BO'" ><img src="../../img/borrar.png" width="25px" /></button>
                        </td> 
                    </tr>
                </table>
                <br>
            ...
            <div class='form-group'>
                ...
                <select class='form-control' size='1'  v-model='solicitud_uniforme_detalle.id_producto'  @change="buscarDatosProducto" >
                    ...
                    <option v-for='rows in productoCollection' v-bind:value='rows.id_producto'> ${{ rows.costo }} 
                     {{ rows.descripcion_producto }} {{ rows.nombre_producto }}</option>
                </select>
            </div>  
            <div class='form-group'>
                <div class="row">
