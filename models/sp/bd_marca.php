...
if (check_session()) { 
    switch($received_data->action){
        case 'update': 
            $model = new Marca($data,$connect,$received_data);
            $model->update();
        break;
        case 'insert':
            $model = new Marca($data,$connect,$received_data);
...
{   
    ...
    public function insert(){
        ...
        $query = 'INSERT INTO sp_marca (nombre,descripcion) VALUES (:nombre,:descripcion) ;';
    ...
    public function update(){
        ...
        $query = 'UPDATE sp_marca SET nombre=:nombre,descripcion=:descripcion WHERE  id_marca = :id_marca ;';
    ...
    public function select(){
        ...
        $query = 'SELECT id_marca,nombre,descripcion 
                    FROM sp_marca 
    ...
    public function delete(){
        ...
        $query = 'DELETE FROM sp_marca WHERE id_marca = :id_marca ;'; 
