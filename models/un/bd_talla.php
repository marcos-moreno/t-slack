...
if (check_session()) { 
    switch($received_data->action){
        case 'update': 
            $model = new Talla($data,$connect,$received_data);
            $model->update();
        break;
        case 'insert':
            $model = new Talla($data,$connect,$received_data);
...
{   
    ...
    public function insert(){
        ...
        $query = 'INSERT INTO  un_talla  (valor,activo,id_tipo_producto) VALUES (:valor,:activo,:id_tipo_producto) ;';
    ...
    public function update(){
        ...
        $query = 'UPDATE  un_talla  SET valor=:valor,activo=:activo,id_tipo_producto=:id_tipo_producto WHERE  id_talla = :id_talla ;';
    ...
    public function select(){
        ...
        $query = 'SELECT id_talla,valor,activo,id_tipo_producto 
                    FROM  un_talla   
    ...
    public function delete(){
        ...
        $query = 'DELETE FROM  un_talla  WHERE id_talla = :id_talla ;'; 
