...
if (check_session()) { 
    switch($received_data->action){
        case 'update': 
            $model = new Producto_color($data,$connect,$received_data);
            $model->update();
        break;
        case 'insert':
            $model = new Producto_color($data,$connect,$received_data);
...
{   
    ...
    public function insert(){
        ...
        $query = 'INSERT INTO  un_producto_color  (id_color,id_producto) VALUES (:id_color,:id_producto) ;';
    ...
    public function update(){
        try {
            $data = array(
                    ':id_producto_color' => $this->received_data->model->id_producto_color, 
                            ':id_color' => $this->received_data->model->id_color, 
                            ':id_producto' => $this->received_data->model->id_producto, 
                             
                    ); 
        $query = 'UPDATE  un_producto_color  SET id_color=:id_color,id_producto=:id_producto WHERE  id_producto_color = :id_producto_color ;';
    ...
    public function select(){
        ...
        $query = 'SELECT id_producto_color,id_color,id_producto 
                    FROM  un_producto_color   
    ...
    public function delete(){
        ...
        $query = 'DELETE FROM  un_producto_color  WHERE id_producto_color = :id_producto_color ;'; 
