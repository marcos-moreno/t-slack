...
if (check_session()) { 
    switch($received_data->action){
        case 'update': 
            $model = new Color($data,$connect,$received_data);
            $model->update();
        break;
        case 'insert':
            $model = new Color($data,$connect,$received_data);
...
{   
    ...
    public function insert(){
        try {
            $data = array(
                    ':nombre_color' => $this->received_data->model->nombre_color,
                            ':activo' => $this->received_data->model->activo,
                            
                    ); 
        $query = 'INSERT INTO un_color (nombre_color,activo) VALUES (:nombre_color,:activo) ;';
    ...
    public function update(){
        ...
        $query = 'UPDATE un_color SET nombre_color=:nombre_color,activo=:activo WHERE  id_color = :id_color ;';
    ...
    public function select(){
        ...
        $query = 'SELECT id_color,nombre_color,activo 
                    FROM un_color  
    ...
    public function delete(){
        ...
        $query = 'DELETE FROM un_color WHERE id_color = :id_color ;'; 
